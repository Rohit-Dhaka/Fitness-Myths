    ...
    return (
        <section className='background-black position-relative '>
            <div className=" position-absolute group4">
                <img src={Group4} alt="group_img" />
            </div>
            <div className=" position-absolute group2">
                <img src={Group2} alt="group_img" />
            </div>
            <Container className='max-w-1200'>
                <Row className='pt-lg-115 pt-sm-100 pt-60 align-items-end justify-content-between '>
                    <div className="col-lg-6 col-12 position-relative d-flex justify-content-lg-start justify-content-center" data-aos="fade-up">
                        <img src={Man} alt="man-img" className=' w-100 max-w-539 mx-auto' />
                        <div className=" position-absolute icon">
                            <img src={Icon} alt="icon" className=' d-lg-block d-none' />
                        </div>
                    </div>
                    <div className="col-lg-5 col-12 pt-lg-0 pt-sm-5 pt-4" data-aos="fade-up">
                ...
                <div className="pt-lg-312 pt-sm-100 pt-60 mx-xl-0 mx-3 d- none">
                    <Row className=' yellow-box position-relative flex-wrap-reverse '>
                        <div className="col-lg-6 col-12" data-aos="fade-up">
                            ...
                            <div className='border-black  d-inline-block  position-relative'>
                                <button className='download-btn text-white font-Eurostile fw-bold fs-16 lh-16 '>Download For Free</button>
                                <div className="yellow-line position-absolute"></div>
                            </div>
                        </div>
                        <div className="col-lg-6 col-12 d-flex justify-content-lg-end  justify-content-center" data-aos="fade-up">
                            <div className="  ipat-img">
                                <img src={Ipad} alt="ipad_img" className=' w-100' />
                            </div>
                        </div>
                    </Row>
                </div>
