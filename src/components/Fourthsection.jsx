        ...
        <section className='bg-yellow-img'>
            <Container className='max-w-1107'>
                <Row className='pt-49 pb-50 align-items-center flex-wrap-reverse'>
                    <div className="col-lg-8 col-md-6 pt-lg-0 pt-sm-5 pt-4" data-aos="fade-up">
                    ...
                    <div className="col-lg-4 col-md-6 d-flex justify-content-lg-end justify-content-center" data-aos="fade-up">
                        <div className="eBook">
