...
const Hero = () => {
  return (
    <header className='hero-background'>
      <nav className='pt-13 pb-13' data-aos="fade-down">
        <Container className='max-w-1100'>
          <div className="w-100 d-flex justify-content-end">
            <div className='border-yellow    position-relative'>
              <button className='Get-in-btn text-black font-Eurostile fw-bold fs-14 lh-14 '>GET IN TOUCH</button>
      ...
      <Container className='max-w-1100'>
        <Row className='align-items-center pb-96 pt-lg-109 pt-5 flex-wrap-reverse ' data-aos="zoom-in">
          ...
          <div className="col-lg-4 col-md-6 col-12 d-flex justify-content-md-start justify-content-center">
            <img src={Image1} alt="img" className=' w-100 firstebook' />
          </div>
        </Row>
      </Container>
    </header>
