        ...
        <section className='background-black position-relative -mt-1'>
            ...
            <Container  className='max-w-1147'>
                <Row className='pb-lg-168 pb-sm-100 pb-60 align-items-center'>
                    <div className="col-md-6 col-12 position-relative z-1 d-flex justify-content-md-start justify-content-center" data-aos="fade-up">                        
                            <div className="Ellipse2 position-absolute  z-n1 "></div>                        
                        <img src={Laptop} alt="laptop" className=' w-100  max-w-530' />
                    </div>
                    <div className="col-md-6 col-12 d-flex justify-content-md-end justify-content-center pt-sm-5 pt-4 pt-lg-0" data-aos="fade-up">
